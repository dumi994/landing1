      ...
      <div className={`${styles.info} d-flex justify-content-center col-md-12 col-lg-6  `} >
        <div className='justify-content-center align-items-center d-flex flex-column w-100'>
          <div className={`${classes.fbuttonCont} mb-5`}>
            <PillButton className={`${classes.fbutton}`}><a href="tel:3913449739"><i className="fa-solid fa-phone"></i><span> 3913449739</span></a></PillButton>
          </div>
          <div  className={`${classes.fbuttonCont}`}>
            <PillButton className={classes.fbutton }><a href="mailto:mail@example.it"><i className="fa-solid fa-envelope"></i><span> mail@example.com</span></a></PillButton>
          </div>
